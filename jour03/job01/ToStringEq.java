...
import jour03.job01.rectangle.coloredrectangle.ColoredRectangle;
...
public class ToStringEq {
    public static void main(String[] args) {
        ...
        Rectangle rect1 = new ColoredRectangle(12.5,4.0, "rouge");
        System.out.println(rect1);
        System.out.println();

        System.out.println("Test 3:");
        Rectangle rect2 = new ColoredRectangle(25.0/2,8.0/2, new String("rouge"));
